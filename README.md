...
Below, the performance of the agent over 32 trial runs is documented. The shaded region represents a standard deviation of the average evaluation over all trials.

<p align="center">
    <img src="https://dr3ngl797z54v.cloudfront.net/bipedal-walker-32-trial-avg.png" width="80%" alt="training-results">
</p>
